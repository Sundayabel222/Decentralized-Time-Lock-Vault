...
// ----------------------------------------------------------------
//  Timestamp-based deposit helpers
// ----------------------------------------------------------------
...
/// Remove a depositor from the global index only when they have no remaining
/// active deposits in either the timestamp or ledger store.
